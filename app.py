...
But instead of above we also can write more effetient code using List Comprehension
...
ref: https://stackoverflow.com/questions/41191412/no-module-named-mem-profile
